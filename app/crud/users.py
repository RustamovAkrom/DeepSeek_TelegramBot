...
class CRUDUser:
    ...
    async def get_by_tg_id(
        session: AsyncSession, tg_id: int, load_history: bool = False
    ) -> Optional[User]:
    ...
    async def update_meta(
        session: AsyncSession, user: User, new_meta: Dict[str, Any]
    ) -> User:
        current_meta = user.meta or {}
    ...
    @staticmethod
    async def delete_meta_field(session: AsyncSession, user: User, key: str) -> User:
        current_meta = user.meta or {}
